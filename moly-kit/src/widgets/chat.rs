...
impl Chat {
    ...
    pub fn handle_submit(&mut self, cx: &mut Cx) {
    ...
    fn handle_send_task(&mut self, cx: &mut Cx) {
        ...
        let future = async move {
            ...
            let message_stream = amortize(client.send(&bot.id,chat_id, &messages_history_context, &tools));
    ...
    pub fn set_chat_id(&mut self, _cx: &mut Cx, chat_id: u128) {
