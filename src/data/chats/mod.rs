...
use super::providers::{
    fetch_models_for_provider, Provider, ProviderBot, ProviderConnectionStatus, ProviderFetchModelsResult,
...
pub struct Chats {
    ...
    pub knowledge_base: HashMap<String, KnowledgeBase>,
...
impl Chats {
    ...
    pub fn register_kb(
        ...
        let agent_id = agent.id.clone();
        self.knowledge_base.insert(agent_id, agent.clone());
    }
    ...
    pub fn insert_or_update_kb(
        &mut self,
        agent: &KnowledgeBase,
    ) {
        self.register_kb(agent.clone());
    }
